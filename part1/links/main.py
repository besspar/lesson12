...
# TODO инициализируйте приложение фласк здесь
...
def students_page():
    return ("<h1>Наши студенты</h1>"
            "<ul><li>Чаурина Луиза</li><li>Доценко Ефросинья</li><li>Ичёткин Епифан</li></ul>"
...
def courses_page():
    return ("<h1>Наши курсы</h1>"
            "<ul><li>Статистика</li><li>Мехатроника</li><li>Аналитика данных</li></ul>"
            "<p><a href='/'>Вернуться на главную</a></p>")
